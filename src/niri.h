...
public:
  ...
  KeyboardLayouts *keyboardLayouts() const;
  ...
  // Keyboard layout actions. Read more: `niri msg action switch-layout``
  Q_INVOKABLE QVariantMap switchLayoutNext();
  Q_INVOKABLE QVariantMap switchLayoutPrev();
  Q_INVOKABLE QVariantMap switchLayoutByIndex(int idx);
